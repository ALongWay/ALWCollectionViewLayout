...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)gestureRecognizer
{
    switch(gestureRecognizer.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            NSLog(@"handleLongPressGestureBegan destinationItemCenter : %@", NSStringFromCGPoint(self.destinationItemCenter));
...
- (void)updateCollectionViewItems
{
    ...
    self.destinationItemCenter = collectionViewCell.center;
    NSLog(@"updateCollectionViewItems destinationItemCenter : %@", NSStringFromCGPoint(self.destinationItemCenter));
